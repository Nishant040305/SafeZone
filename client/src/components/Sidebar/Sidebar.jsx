        ...
        <>
            ...
            {!isCollapsed ? (
                ...
                >
                    ...
                    {/* Sidebar items */}
                    <div className={`flex flex-col items-center mt-6 ${isCollapsed ? "hidden" : "block"}`}>
                        <a
                            href="#"
                        ...
                        >
                            ...
                            <span className="text-xl font-semibold text-blue-600">Report</span> {/* Styled text */}
                        </a>
                        <a
                            href="#"
                            className="w-full p-4 text-center text-gray-700 hover:bg-gray-200 cursor-pointer flex items-center justify-center space-x-2"
                        >
                            ...
                            <span className="text-xl font-semibold text-blue-600">Profile</span> {/* Styled text */}
                        </a>
                    </div>
                    <button className="bg-red-600 bottom-1 transform translate-x-[50%] fixed text-white p-2 rounded-lg border m-3 font-md flex items-center" onClick={dispatch(logout())}>
